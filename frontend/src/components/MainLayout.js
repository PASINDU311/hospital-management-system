...
function MainLayout() {
  ...
  return (
    <div className="d-flex" style={{ minHeight: '100vh' }}>
      ...
      <div className="sidebar p-3 d-flex flex-column justify-content-between" style={{ width: '250px', shrink: 0 }}>
        <div>
          <div 
          ...
          <nav className="nav flex-column">
            <button 
              type="button" 
              className={`nav-link text-start border-0 bg-transparent ${isActive('/patient-dashboard') ? 'active' : ''}`}
              onClick={() => navigate('/patient-dashboard')}
            >
              📊 Dashboard
            </button>
